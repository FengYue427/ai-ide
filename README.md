...
**v1.0.3.4** · [1.0.3.x 已收官](docs/ROADMAP_V1.0.3.x.md) · 下一世代 **[v1.1 RFC](docs/V1.1_RFC_STUB.md)** · BYOK — 见 [CHANGELOG.md](./CHANGELOG.md)

| | 链接 |
|--|------|
| **在线体验** | https://ai-ide-flame.vercel.app |
| **桌面版（Win / macOS）** | https://github.com/FengYue427/ai-ide/releases/latest |
...
> 宣传稿（掘金/V2EX）：[docs/publish/](docs/publish/) · 上线清单：[GO_LIVE_NOW.md](docs/GO_LIVE_NOW.md) · **1.0.3 大规划**：[V1.0.3_MASTER_PLAN.md](docs/V1.0.3_MASTER_PLAN.md)
...
- 项目规则 `.aide/rules.md` / **任务清单** `.aide/tasks.md` 自动注入
- Agent 多文件编辑 + **块级 Diff** + **grep_repo**（6 工具）
