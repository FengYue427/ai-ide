...
> **并行 B 轨**：[ROADMAP_V1.1_LONG_HORIZON.md](./ROADMAP_V1.1_LONG_HORIZON.md) · 桌面/稳定 patch 已合入 **v1.1.8**
...
| **1.1.7.2** | **Electron inspect attach** | 桌面 bound 文件夹 `node --inspect-brk`；复用 CDP 客户端 | P0 | ✅ |
| **1.1.7.3** | **调试稳定性** | 断点重连 · 会话结束清理 · 大文件断点 URL 匹配 | P0 | ✅ |
