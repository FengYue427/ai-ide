...
> **下一 B 轨**：**v1.2.0 已开波** — [V1.2_KICKOFF.md](./V1.2_KICKOFF.md)
...
| 版本 | 主题 | 状态 |
|------|------|:----:|
| **1.1.9.1** | 已安装插件 SDK 徽章 · 文档链接 · smoke `platformAi` | ✅ |
| **1.1.9.2** | 插件作者 `PLUGIN_SDK_V2` 示例扩展（可选 API） | 并入 v1.2.0 F5 或按需 patch |
| **1.1.9.3** | AI 聊天区占比：紧凑控制条 + 可折叠详情 | ✅ |
