...
| 版本 | 主题 | 说明 | 优先级 |
|------|------|------|:------:|
| **1.1.5.2** | **Scripts 运行反馈** | 跑 script 失败 Toast、last-run 高亮持久 | P0 |
| **1.1.5.3** | **Tasks 面板** 空态 / 大清单性能 | 虚拟列表或分组折叠 | P1 |
| **1.1.5.4** | 终端 **多 session** 探索（单 tab 内） | 非 PTY，仅 jsh 会话切换 | P2 |
| **1.1.5.5** | **Electron PTY** spike | node-pty 可行性验证 | P2 |
