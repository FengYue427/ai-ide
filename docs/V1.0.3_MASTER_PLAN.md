...
**GA 之后**：沿用第四段 **`1.0.3.1`～`1.0.3.4`** 做观测、域名、计费 SOP、发布收官（**非功能大爆炸**）— 见 [ROADMAP_V1.0.3.x.md](./ROADMAP_V1.0.3.x.md)。
...
| **Must** | `APP_URL` 生产验证（vercel.app 或自定义域二选一） | [V1.0.3_VERCEL_ENV.md](./V1.0.3_VERCEL_ENV.md) |
| **Should** | 自定义域名切换与回归（建议放 `1.0.3.2`） | [CUSTOM_DOMAIN.md](./CUSTOM_DOMAIN.md) |
...
| 任务 | 说明 |
|------|------|
| B-1 | 生产 `APP_URL` 正确（vercel.app 或自定义域）；自定义域回归可后置到 `1.0.3.2` |
...
| W1 | `APP_URL` / Sentry / 文档主体（自定义域可后置） |
...
| [ROADMAP_V1.0.3.x.md](./ROADMAP_V1.0.3.x.md) | **GA 后** 1.0.3.1～1.0.3.4 稳定化 |
