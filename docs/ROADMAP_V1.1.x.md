...
> **更新**：2026-05-29 — **v1.1.5 GA ✅** · **v1.1.6 开波**  
...
| **B · 大更新** | **`1.1.2`** ✅、**`1.1.3`** ✅、**`1.1.4`** ✅、**`1.1.5`** ✅ | **整包 DoD 后一次** | **v1.1.6 开发中** |
...
| **v1.1.6** | **Git 可视化** | **B** | 🔄 [V1.1.6_KICKOFF.md](./V1.1.6_KICKOFF.md) |
| **v1.1.7～1.1.9** | 调试 / 插件 / 多根 | **B** | 📋 [ROADMAP_V1.1_LONG_HORIZON.md](./ROADMAP_V1.1_LONG_HORIZON.md) |
...
| [ROADMAP_V1.1_LONG_HORIZON.md](./ROADMAP_V1.1_LONG_HORIZON.md) | v1.1.7～1.1.9.x |
