...
> **更新**：2026-05-30 — **v1.1.4 GA ✅** · **v1.1.5 开波**  
...
| **B · 大更新** | **`1.1.2`** ✅、**`1.1.3`** ✅、**`1.1.4`** ✅ | **整包 DoD 后一次** | **v1.1.5 开发中** |
...
| **v1.1.5** | **终端 + 任务** | **B** | 🔄 [V1.1.5_KICKOFF.md](./V1.1.5_KICKOFF.md) |
| **v1.1.6～1.1.9** | Git / 调试 / 插件 / 多根 | **B** | 📋 [ROADMAP_V1.1_LONG_HORIZON.md](./ROADMAP_V1.1_LONG_HORIZON.md) |
