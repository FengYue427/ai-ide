...
> **更新**：2026-06-04  
> **状态**：**v1.2.6 GA** ✅ · **v1.2.7 GA** ✅ · **v1.2.8 GA** ✅ · **v1.2.9 GA** ✅ · **当前**：v1.3 📋  
...
| **v1.2.5** ✅ | 质量/生态 E2E — [RELEASE_NOTES_v1.2.5.md](./RELEASE_NOTES_v1.2.5.md) |
| **v1.2.6** ✅ | 语义导航/预检/生产开关 — [RELEASE_NOTES_v1.2.6.md](./RELEASE_NOTES_v1.2.6.md) |
| **v1.2.7** ✅ | 导航 E2E · payload · 插件/平台 — [RELEASE_NOTES_v1.2.7.md](./RELEASE_NOTES_v1.2.7.md) |
| **v1.2.8** ✅ | 引用 Peek · MCP · 插件发布 DB — [RELEASE_NOTES_v1.2.8.md](./RELEASE_NOTES_v1.2.8.md) |
| **v1.2.9** ✅ | 引用精度 · 动态 MCP · 插件审核运维 — [RELEASE_NOTES_v1.2.9.md](./RELEASE_NOTES_v1.2.9.md) |
...
| [V1.2.9_GA_EXECUTION.md](./V1.2.9_GA_EXECUTION.md) | v1.2.9 发版清单 |
| [ROADMAP_V1.1_LONG_HORIZON.md](./ROADMAP_V1.1_LONG_HORIZON.md) | 1.1.x 世代 |
| [ROADMAP_V1.3.md](./ROADMAP_V1.3.md) | v1.3 大拓展 |
