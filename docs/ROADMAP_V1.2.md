...
> **更新**：2026-06-04  
> **状态**：**v1.2.4 GA** ✅ · **v1.2.5 GA** ✅ · **v1.2.6 GA** ✅ · **当前**：v1.2.7 📋  
> **Kickoff**：[V1.2.7_KICKOFF.md](./V1.2.7_KICKOFF.md) · **Release**：[RELEASE_NOTES_v1.2.6.md](./RELEASE_NOTES_v1.2.6.md)
...
| **v1.2.7** 📋 | 导航 E2E · payload · 插件/平台 — [V1.2.7_KICKOFF.md](./V1.2.7_KICKOFF.md) |
