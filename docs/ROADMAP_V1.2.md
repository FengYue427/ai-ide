...
> **更新**：2026-06-01  
> **状态**：**v1.2.0 GA** ✅ · **v1.2.2 GA** ✅ · **v1.2.3 GA** ✅ · **当前 B 轨**：v1.2.4（Agent/索引）📋  
> **Kickoff**：[V1.2_KICKOFF.md](./V1.2_KICKOFF.md) · **Release**：[RELEASE_NOTES_v1.2.3.md](./RELEASE_NOTES_v1.2.3.md)
...
| **v1.2.4** 📋 | Agent/索引 · 全栈 E2E — [V1.2.4_KICKOFF.md](./V1.2.4_KICKOFF.md) |
