...
> **更新**：2026-06-04  
> **状态**：**v1.2.6 GA** ✅ · **v1.2.7 GA** ✅ · **v1.2.8 GA** ✅ · **当前**：v1.2.9 📋  
> **Kickoff**：[V1.2.9_KICKOFF.md](./V1.2.9_KICKOFF.md) · **Release**：[RELEASE_NOTES_v1.2.8.md](./RELEASE_NOTES_v1.2.8.md)
...
| **v1.2.9** 📋 | 引用精度 · 动态 MCP · 插件审核运维 — [V1.2.9_KICKOFF.md](./V1.2.9_KICKOFF.md) |
