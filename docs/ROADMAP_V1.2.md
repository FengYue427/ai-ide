...
> **更新**：2026-06-04  
> **状态**：**v1.2.5 GA** ✅ · **v1.2.6 GA** ✅ · **v1.2.7 GA** ✅ · **当前**：v1.2.8 📋  
> **Kickoff**：[V1.2.8_KICKOFF.md](./V1.2.8_KICKOFF.md) · **Release**：[RELEASE_NOTES_v1.2.7.md](./RELEASE_NOTES_v1.2.7.md)
...
| **v1.2.8** 📋 | 引用 Peek · MCP · 插件发布 DB — [V1.2.8_KICKOFF.md](./V1.2.8_KICKOFF.md) |
