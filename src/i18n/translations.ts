export const translations = {
  'zh-CN': {
    ...
    'welcome.onboarding.desc': '① 选模板或导入文件夹 → ② 在设置中配置 AI Key（可选）→ ③ Ctrl+Enter 运行代码。',
    ...
    'debug.waitRuntimeDesc': 'WebContainer 就绪后可启动 Node inspect。',
...
`,
  ...
  'en-US': {
    ...
    'welcome.onboarding.desc':
      '① Pick a template or import a folder → ② Add an AI key in Settings (optional) → ③ Run with Ctrl+Enter.',
    ...
    'debug.waitRuntimeDesc': 'Start Node inspect after WebContainer is ready.',
