export const translations = {
  'zh-CN': {
    ...
    'intent.autopilot.loopBlockedTitle': '步内循环未启动',
    'intent.autopilot.backgroundBlockedTitle': '后台续跑未启动',
    'intent.autopilot.backgroundForegroundTitle': '后台续跑不可用',
    ...
    'chat.stop': '停止生成',
    'chat.sendButton': '发送',
    'chat.attachments.add': '添加图片或文件',
    'chat.attachments.rejectedTitle': '无法添加附件',
    'chat.attachments.rejectedLimit': '最多 4 个附件',
    'chat.attachments.rejectedSize': '文件过大（图片 ≤4MB，文本 ≤32KB）',
    'chat.attachments.rejectedType': '不支持该文件类型',
    ...
    'wp.local.desktopApiUnavailable':
      '桌面原生接口未就绪。请使用菜单 File → Open Project Folder（Ctrl+O），或重启桌面应用后再试。',
    ...
    'git.error.fsUnavailable': 'Git 文件系统不可用，请先打开项目或等待 WebContainer 就绪。',
    'git.error.desktopProjectNotBound': '请先用 File → Open Project Folder（Ctrl+O）绑定本地项目文件夹。',
    'git.createBranch': '创建',
    ...
    'terminal.ptyHint': '桌面 PTY：完整交互式 shell。',
    'terminal.ptyActive': 'PTY shell 已连接',
    'terminal.ptyFallback': 'PTY 不可用（{reason}），已回退单行命令模式。',
...
`,
  ...
  'en-US': {
    ...
    'intent.autopilot.loopBlockedTitle': 'Foreground loop not started',
    'intent.autopilot.backgroundBlockedTitle': 'Background watch not started',
    'intent.autopilot.backgroundForegroundTitle': 'Background watch unavailable',
    ...
    'chat.attachments.add': 'Attach image or file',
    'chat.attachments.rejectedTitle': 'Attachment not added',
    'chat.attachments.rejectedLimit': 'Up to 4 attachments allowed',
    'chat.attachments.rejectedSize': 'File too large (images ≤4MB, text ≤32KB)',
    'chat.attachments.rejectedType': 'Unsupported file type',
    ...
    'wp.local.desktopApiUnavailable':
      'Desktop native API is not ready. Use File → Open Project Folder (Ctrl+O), or restart the desktop app.',
    ...
    'git.pull': 'Pull',
    'git.push': 'Push',
    'git.pullDone': 'Pull complete',
    'git.pushDone': 'Push complete',
    'git.noRemote': 'No origin remote configured',
    ...
    'git.error.fsUnavailable': 'Git filesystem unavailable. Open a project or wait for WebContainer.',
    'git.error.desktopProjectNotBound': 'Bind a local folder first via File → Open Project Folder (Ctrl+O).',
    ...
    'terminal.ptyHint': 'Desktop PTY: full interactive shell.',
    'terminal.ptyActive': 'PTY shell connected',
    'terminal.ptyFallback': 'PTY unavailable ({reason}); using line command mode.',
