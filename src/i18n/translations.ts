...
`,
    ...
    'activityLine.title': 'Activity Line（实验）',
    'activityLine.eventCount': '{count} 条事件',
    'activityLine.empty': '暂无运行事件（orchestrator stub 模式）',
...
`,
    ...
    'activityLine.title': 'Activity Line (experimental)',
    'activityLine.eventCount': '{count} events',
    'activityLine.empty': 'No runtime events yet (orchestrator stub mode)',
    'settings.aideRuntime.stubCardTitle': 'AIDE Runtime stub',
    'settings.aideRuntime.stubCardDesc':
