...
export const JA_JP_BULK_OVERRIDES: Partial<Record<TranslationKey, string>> = {
  ...
  'subscription.plan.enterprise.f6': '100GB cloud storage · priority support',
  ...
  'welcome.networkTipsSelfHosted':
    'Self-hosted deploy: ensure API health and auth cookies match your domain. Slow loads? Check reverse proxy and database connectivity.',
  ...
  'welcome.desktopDownload.title': 'Windows デスクトップ版',
  'welcome.desktopDownload.desc': 'ローカルフォルダ・ネイティブ Git・フルターミナル。ブラウザ WebContainer に依存しません。',
  'welcome.desktopDownload.button': 'ポータブル版をダウンロード（約 96 MB）',
  'welcome.desktopDownload.hint': '初回起動で「不明な発行元」と表示されたら「実行」を選んでください（未コード署名）。',
