...
export const getDefaultShortcuts = (actions: {
  ...
  'ctrl+shift+g': actions.onToggleGitPanel || (() => {}),
  'ctrl+alt+1': actions.onOpenTerminalTab || (() => {}),
  'ctrl+alt+2': actions.onOpenScriptsTab || (() => {}),
  'ctrl+alt+3': actions.onOpenTasksTab || (() => {}),
  'ctrl+alt+4': actions.onOpenDebugTab || (() => {}),
  'ctrl+b': actions.onToggleSidebar || (() => {}),
  'ctrl+shift+i': actions.onFormat || (() => {}),
  'escape': actions.onClosePanel || (() => {}),
  'f5': actions.onDebugContinue || (() => {}),
  'f10': actions.onDebugStepOver || (() => {}),
  'f11': actions.onDebugStepInto || (() => {}),
  'shift+f11': actions.onDebugStepOut || (() => {}),
  'shift+f5': actions.onDebugStop || (() => {}),
})
