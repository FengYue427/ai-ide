...
export const API_MESSAGES = {
  ...
  'en-US': {
    ...
    'api.storage.limitReached':
      'Cloud storage limit reached ({limitGb} GB). Upgrade to Pro or Team for more space.',
    ...
    'api.autopilot.dailyLimitUpgrade':
      'Daily Autopilot limit reached. Upgrade to Pro for unlimited Spec queue runs.',
